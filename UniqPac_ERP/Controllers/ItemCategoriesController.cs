...
namespace UniqPac_ERP.Controllers
{
    public class ItemCategoriesController : Controller
    {
        ...
        // GET: ItemCategories
        [Authorize(Policy = Permissions.ItemCategories.View)]
        ...
        [Authorize(Policy = Permissions.ItemCategories.Create)]
        ...
        [Authorize(Policy = Permissions.ItemCategories.Create)]
        public async Task<IActionResult> Create([Bind("Id,CategoryCode,CategoryName,Description,CreatedAt,CreatedBy,UpdatedAt,UpdatedBy,IsActive,IsDeleted")] ItemCategory itemCategory)
        {
        ...
        [Authorize(Policy = Permissions.ItemCategories.Edit)]
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Policy = Permissions.ItemCategories.Edit)]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryCode,CategoryName,Description,CreatedAt,CreatedBy,UpdatedAt,UpdatedBy,IsActive,IsDeleted")] ItemCategory itemCategory)
        {
        ...
        [Authorize(Policy = Permissions.ItemCategories.Delete)]
